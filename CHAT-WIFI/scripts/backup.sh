...
echo ""
echo -e "${YELLOW}💡 Backup guardado en el servidor. Para descargarlo:${NC}"
echo -e "   Desde AWS Console → EC2 → Instance Connect"
echo -e "   O con AWS CLI: aws s3 cp $BACKUP_ROOT/${TIMESTAMP}.tar.gz s3://tu-bucket/"
echo ""
