...
router.put('/config', async (req, res) => {
    try {
        const { isEnabled, messageText, cooldownHours, videoEnabled, imageEnabled, messageDelays, responseDelay, greetingByTimeEnabled, postVideoMessage, postVideoDelays } = req.body;
